...
//! positions on Earth, along with comprehensive coordinate parsing that handles
//! virtually any format a user might enter.
//!
...
impl Location {
    ...
    ///
    /// This is the most comprehensive parsing function that handles virtually any
    /// coordinate format a user might enter. It automatically detects the format
    /// and applies appropriate parsing logic.
    ///
    /// # Supported Formats
    ///
    /// ## Decimal degrees
...
/// Comprehensive coordinate parser that handles virtually any format
